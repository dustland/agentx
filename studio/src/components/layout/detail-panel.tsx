...
export function DetailPanel({ taskId }: DetailPanelProps) {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <TabsContent value="terminal" className="flex-1 p-4 m-0">
          <Card className="h-full">
            ...
            <CardContent>
              <div className="bg-black/90 text-green-400 p-4 rounded font-mono text-xs h-[calc(100vh-300px)] overflow-auto">
                <div>$ agentx run task_{taskId}</div>
                <div className="mt-2">Initializing agents...</div>
                <div>Loading team configuration...</div>
                <div>Starting task execution...</div>
                <div className="mt-2 text-yellow-400">[researcher] Starting market analysis...</div>
                <div className="text-gray-400">└─ Searching for relevant data sources</div>
                <div className="text-gray-400">└─ Analyzing trends and patterns</div>
                <div className="mt-2 text-blue-400">[writer] Generating report...</div>
                <div className="text-gray-400">└─ Structuring findings</div>
                <div className="text-gray-400">└─ Creating visualizations</div>
                <div className="mt-2 text-green-400">✓ Task completed successfully</div>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
