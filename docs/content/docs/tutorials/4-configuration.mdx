...
AgentX uses YAML configuration files to define agent teams and their behavior. This guide covers everything you need to know about organizing and configuring your AgentX projects effectively.

## Quick Start

Every AgentX project starts with a `team.yaml` file that defines your agent team:
...
│       └── api_tools.py
├── workspace/
│   ├── research/              # Domain-specific workspaces
│   ├── development/
│   └── qa/
└── main.py
```
...
AgentX supports environment variable substitution for secure configuration:
...
$schema: "https://raw.githubusercontent.com/your-org/agentx/main/schemas/team.yaml"
...
Now that you understand how to configure AgentX:
...
- [Examples](https://github.com/your-org/agentx/tree/main/examples) - Real-world examples
