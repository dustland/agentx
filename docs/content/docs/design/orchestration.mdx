...
- **Automatic Workspace Management**: Handles file storage, artifact management, and workspace organization
...
- **Persistent**: Saved to workspace for resumability
