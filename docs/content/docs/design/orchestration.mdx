...
description: "The core design and principles for coordinating autonomous agents in VibeX."
---
...
The VibeX orchestration model is designed to coordinate multiple autonomous agents to achieve complex goals reliably and predictably. The architecture is built on three core principles:
...
```python
from vibex.core.message import Message, TextPart, ArtifactPart
