...
Deep dive into how AgentX manages state, context, and memory across agents and tasks. Covers taskspace isolation, memory systems, and context propagation.
...
Stateless, single-purpose experts defined by prompt files. Each agent has one clear responsibility (planning, research, writing, etc.) and is invoked by the Lead to perform specific micro-tasks. AgentX includes a standard library of common agents.
