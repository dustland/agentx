...
- **Two implementations:**
  - `BaseOrchestrator`: Abstract class for custom orchestration logic
  - `Orchestrator`: Default implementation with LLM-based intelligent routing
...
- **Orchestrator Invoker:** Calls the Orchestrator and provides it with agents and tools
