...
VibeX is a Python framework for building multi-agent AI systems. Get started with these three progressive examples.
...
Let's start with the simplest possible VibeX setup - a single chat agent.
...
🎉 **Result:** You now have a working chat agent! This demonstrates the core VibeX conversational interface.

---

## 2. Multiple Agents with Tools (Auto Writer)

Now let's see the real power of VibeX - multiple specialized agents working together with tools.
...
# All agents are presets from VibeX framework
agents:
...
- [System Architecture](./design/system-architecture) - Understand how VibeX works internally
- [API Reference](./api/core) - Complete technical documentation

### 🚀 Working Examples

All examples are in the [examples directory](https://github.com/dustland/vibex/tree/main/examples):
...
- **Examples**: [Working Examples](https://github.com/dustland/vibex/tree/main/examples)
- **Community**: [GitHub Discussions](https://github.com/dustland/vibex/discussions)
