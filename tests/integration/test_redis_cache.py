...
This script demonstrates using the ProjectStorageFactory with Redis caching
...
async def test_redis_cache_scenario():
    ...
    try:
        ...
        try:
            ...
            redis_cache = ProjectStorageFactory.get_cache_provider("redis")
        ...
        # 2. Create project_storage with Redis cache (if available)
        if redis_available:
            print("\n2. Creating project_storage with Redis caching...")
            ...
            # Worker 2 accesses same data (different project_storage instance)
            worker2_taskspace = ProjectStorageFactory.create_project_storage(
                base_path=temp_dir,
            ...
            memory_taskspace = ProjectStorageFactory.create_project_storage(
                base_path=temp_dir,
