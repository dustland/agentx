...
function ToolCallPartComponent({ part }: { part: ToolCallPart }) {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 rounded-md border border-border bg-card/50 dark:bg-card/30 my-2">
      {/* Status Icon */}
      ...
      {isFileOperationResult && onArtifactSelect && (
        <div className="px-3 pb-2 border-t border-border">
          <Button
            variant="ghost"
            size="sm"
            className="h-7 text-xs px-2 text-primary hover:text-primary hover:bg-primary/10 w-full justify-start mt-2"
      ...
      {isExpanded && (
        <div className="px-3 pb-3 border-t border-border">
          <div className="mt-2">
            <pre
              className={cn(
                "text-xs p-3 rounded-md overflow-x-auto max-h-64",
