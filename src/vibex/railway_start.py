#!/usr/bin/env python3
"""
Railway deployment starter for VibeX
...
def start_services():
    ...
    # Start API server
    print(f"Starting VibeX API on port {api_port}...")
    ...
    if studio_path.exists():
        print(f"Starting VibeX Studio on port {studio_port}...")
        studio_env = {
            **os.environ,
            "PORT": studio_port,
